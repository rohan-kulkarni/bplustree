...
/**
 * The {@code ZoomGraphics} class implements java.awt.Graphics equivalents with zooming capabilities.
 * 
...
public class ZoomGraphics {
	...
	/**
	 * Sets this {@code ZoomGraphics}' current font size.
	 * 
	 * @param size
	 *            the font size
	 */
	...
	/**
	 * Draws the text given by the specified string, using this {@code ZoomGraphics}' current font and color.
	 * 
	 * @param s
	 *            the text string
	 * @param x
